...
(use-package eyebrowse
 ...
 #+end_src
** quelpa for git fetch packagings
#+begin_src emacs-lisp
(require 'quelpa)
#+end_src
** svg
...
(use-package vue-mode
  ...
  (add-hook 'vue-html-mode-hook #'lsp))
...
(use-package org
  ...
  :config
  (setq org-plantuml-jar-path (expand-file-name "~/opensource/plantuml/plantuml.jar"))
...
(defun my-initial-window-setup ()
    ...
    (other-window 1)
    (mu4e)
    (mu4e~headers-jump-to-maildir "/familie-uhlich/inbox")
    (other-window 1)
    (mu4e-dashboard)
    )
