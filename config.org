...
(use-package tide
  :ensure t
  :init
  ;;(setq tide-tsserver-executable "~/.nvm/versions/node/v12.16.3/bin")
  (setq exec-path (append exec-path '("~/.nvm/versions/node/v12.16.3/bin")))
  )
...
'((:url "https://p45-caldav.icloud.com/201066911/calendars/Kalender" 
:calendar-id "" :files ("~/SynologyDrive/Drive/org/icloud.org")
:inbox "~/org/ionbox.org")
       )
))  
#+end_src
                ...
                ((org-agenda-overriding-header "")
                 (org-super-agenda-groups
                  '((:name "⚡ Next to do:" :tag "nextaction" :order 1)
                    ...
                    (:name "⚡ Due Soon:" :deadline (before "+7d") :order 8)
