...
#+begin_src emacs-lisp
; this is a workaround since latest doom-modeline with nerd fonts has a performance issue in this setup
(add-to-list 'load-path "~/opensource/doom-modeline-3.4.0")
(load "doom-modeline")
